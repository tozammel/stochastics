...
public class DiagonalExtendedApproximatePowerlawMututallyExcitingProcessTest extends TestCase
{
         ...
         testMeanRecurrenceTime()
  {
    DiagonalExtendedApproximatePowerlawMututallyExcitingProcess process =
                                                                        DiagonalExtendedApproximatePowerlawMututallyExcitingProcessTest.constructLongerProcess();
         ...
         testIntensity() throws InterruptedException
  {
    ...
    assertTrue("should equal " + trueIntensity0 + " not " + intensityFast, trueIntensity0.equals(intensityFast, pow(10, -9)));
