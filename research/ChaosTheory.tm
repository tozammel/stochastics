...
<\body>
  ...
  <\equation>
    g<around*|(|n|)>=<around*|{|\<vartheta\><around*|(|t|)>=<around*|(|n-1|)>\<pi\>|}>
  </equation>

  A very accurate approximation <math|<wide|g|~><around*|(|n|)>> to the Gram
  points <math|g<around*|(|n|)>> is found by inverting
  ...
  <\proposition>
    The set of Gram points is the compensator of the stochsatic process
    generated by the location of the roots of <math|Z<around*|(|t|)>> along
    the real line and <math|S<around*|(|t|)>=<frac|1|\<pi\>>arg<around*|(|<frac|1|2>+i
    t|)>> is the innovation martingale which jumps by the multiplicity of the
    corresponding root at each point where <math|Z<around*|(|t|)>=0>
  </proposition>

  <\proof>
    <math|<tabular*|<tformat|<cwith|1|-1|1|-1|cell-halign|l>|<table|<row|<cell|<wide|g|~><rsup|-1><around*|(|n|)>>|<cell|=<around*|{|t:<wide|g|~><around*|(|n|)>=0|}>>>|<row|<cell|>|<cell|=<frac|t
    ln<around*|(|<frac|t|2 \<pi\> e>|)>|2
    \<pi\>>+<frac|7|8>>>|<row|<cell|>|<cell|=<wide|N|~><around*|(|t|)>-S<around*|(|t|)>>>|<row|<cell|>|<cell|=<wide|N|~><around*|(|t|)>-S<around*|(|t|)>>>>>>>
  </proof>

  <\definition>
    (Compensator) The compensator <math|Y<around*|(|t|)>> of a stochastic
    process <math|X<around*|(|t|)>> is a function such that its innovation
    martingale <math|Y<around*|(|t|)>-X<around*|(|t|)>> is distributed like
  ...
  <\proof>
    ...
    <\equation>
      <tabular|<tformat|<table|<row|<cell|=<frac|\<vartheta\><around*|(|t|)>|\<pi\>>+3-<frac|3|2>-<frac|\<vartheta\><around*|(|t|)>|\<pi\>>-<frac|3|2>=3-<frac|3|2>-<frac|3|2>>>|<row|<cell|=3-3>>|<row|<cell|=0>>>>>
    </equation>
  </proof>

  <subsubsection|A Bad/Good Gram Point Indicator>

  Let\ 

  <\equation>
    g<around*|(|n|)>=2 \<pi\>e<rsup|1+W<around*|(|<frac|8n+1|8e>|)>>
  </equation>

  be the approximate value of the <math|n>-th Gram point.\ 

  <\proposition>
    Let

    <\equation>
      G<around*|(|n|)>=<frac|Z<around*|(|g<around*|(|n|)>|)>|<around*|\||Z<around*|(|g<around*|(|n|)>|)>|\|>>+<frac|Z<around*|(|g<around*|(|n+1|)>|)>|<around*|\||Z<around*|(|g<around*|(|n+1|)>|)>|\|>>
    </equation>

    then the function defined by

    <\equation>
      B<around*|(|n|)>=<frac|1|4>G<around*|(|n-1|)>G<around*|(|n|)>
    </equation>

    takes on the value <math|1> when <math|n> is a \Pbad\Q Gram point for
    which <math|<around*|(|-1|)><rsup|n+1>Z<around*|(|g<around*|(|n|)>|)>\<gtr\>0>
    and the value <math|0> when it is a \Pgood\Q Gram point
    <math|<around*|(|-1|)><rsup|n+1>Z<around*|(|g<around*|(|n|)>|)>\<less\>0>.
  </proposition>
...
<\references>
  <\collection>
    ...
    <associate|c|<tuple|10|4>>
    <associate|ec|<tuple|5|2>>
    <associate|ee|<tuple|9|2>>
    <associate|een|<tuple|17|4>>
    <associate|fl|<tuple|20|6>>
    <associate|le|<tuple|18|6>>
  </collection>
</references>
...
<\auxiliary>
  <\collection>
    ...
    <\associate|figure>
      <tuple|normal|<surround|<hidden|<tuple>>||<with|mode|<quote|math>|S<rsub|n><around*|(|t|)>>
      and the imaginary parts of the roots of
      <with|mode|<quote|math>|\<zeta\><around*|(|<frac|1|2>+i t<rsub|n>|)>>
      marked with verticle lines just touching its touching its corresponding
      pair of neighboring curves <with|mode|<quote|math>|S<rsub|n><around*|(|t|)>>
      for <with|mode|<quote|math>|n=0\<ldots\>14>>|<pageref|auto-6>>
      ...
      marked with verticle lines just touching its touching its corresponding
      pair of neighboring curves <with|mode|<quote|math>|S<rsub|n><around*|(|t|)>>
      for <with|mode|<quote|math>|n=120\<ldots\>140> which includes two
      \Pbad\Q Gram points at <with|mode|<quote|math>|n=126> and
      <with|mode|<quote|math>|n=134>>|<pageref|auto-7>>

      <tuple|normal|<surround|<hidden|<tuple>>||Illustration of convergence
      around the first zero>|<pageref|auto-8>>
    </associate>
    <\associate|toc>
      ...
      <with|par-left|<quote|2tab>|1.3.1<space|2spc>A Bad/Good Gram Point
      Indicator <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
