...
<\body>
  ...
  <\equation>
    <tabular|<tformat|<table|<row|<cell|A<rsub|j><around*|(|i|)>>|<cell|=<big|sum><rsub|t<rsub|k>\<leqslant\>t<rsub|i>>e<rsup|-\<beta\><rsub|j><around*|(|t<rsub|i>-t<rsub|k>|)>>>>|<row|<cell|>|<cell|=<big|sum><rsub|k=0><rsup|i-1>e<rsup|-\<beta\><rsub|j><around*|(|t<rsub|i>-t<rsub|k>|)>>>>|<row|<cell|>|<cell|=1+e<rsup|-\<beta\><rsub|j><around*|(|t<rsub|i>-t<rsub|k>|)>>A<rsub|j><around*|(|i-1|)>>>>>><label|A>
  </equation>
  ...
  <\equation>
    <tabular|<tformat|<table|<row|<cell|>|<cell|>>|<row|<cell|\<lambda\><rsub|epl><around*|(|t|)>>|<cell|=<big|int><rsub|-\<infty\>><rsup|t>\<varphi\><rsub|epl><around*|(|t-s|)>\<mathd\>N<rsub|s>>>|<row|<cell|>|<cell|=<big|sum><rsub|t<rsub|k>\<less\>t>\<varphi\><rsub|epl><around*|(|t-t<rsub|k>|)>>>|<row|<cell|>|<cell|=<around*|(|<around*|(|<big|sum><rsub|j=0><rsup|P-1><around*|(|\<eta\>
    m<rsup|-j><rsup|>|)><rsup|1+\<varepsilon\>>
  ...
  <\equation>
    ...
    m<rsup|-j>|)><around*|(|t<rsub|i>-t<rsub|k>|)>>|)>>>|<row|<cell|>|<cell|=<big|sum><rsub|j=1><rsup|P><frac|\<alpha\><rsub|j>|\<beta\><rsub|j>><around*|(|1-e<rsup|-\<beta\><rsub|j>\<Delta\>t<rsub|i>>|)>A<rsub|j><around*|(|i-1|)>>>>>>
  </equation>
...
<\references>
  <\collection>
    <associate|A|<tuple|5|?|../../.TeXmacs/texts/scratch/no_name_15.tm>>
    <associate|auto-1|<tuple|21|3|../../.TeXmacs/texts/scratch/no_name_15.tm>>
    <associate|bib-cf|<tuple|2|3|../../.TeXmacs/texts/scratch/no_name_15.tm>>
    <associate|bib-oaple|<tuple|1|3|../../.TeXmacs/texts/scratch/no_name_15.tm>>
  </collection>
</references>
