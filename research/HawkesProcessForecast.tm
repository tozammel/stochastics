...
<\body>
  <doc-data|<doc-title|Hawkes Process Forecasting>|<doc-author|<author-data|<author-name|<date|>>>>|<doc-author|<author-data|<author-name|<space|5em>Stephen
  ...
  compared with the multivariate compensator where there is the recursion
  ...
  is the expected value of the unconditional mean intensity. The inverse
  compensator is derived by solving for the value of <math|t<rsub|i+i>> (the
  future point) given a value of <math|\<varepsilon\>>

  <\equation>
    <tabular*|<tformat|<table|<row|<cell|<with|font-base-size|14|||||\<Lambda\><rsub|><rsup|-1><around*|(|\<varepsilon\>;\<alpha\><rsub|>,\<beta\><rsub|>|)>>>|<cell|=<around*|{|t<rsub|i+1>:\<Lambda\><rsup|><around*|(|t<rsub|0>,t<rsub|n>|)>=<big|sum><rsub|i=0><rsup|n=N<rsub|t>>\<Lambda\><around*|(|t<rsub|i>,t<rsub|i+1>|)>=\<varepsilon\>|}>>>|<row|<cell|>|<cell|=<tabular|<tformat|<table|<row|<cell|<frac|<tabular|<tformat|<table|<row|<cell|t
  ...
  where <math|A<rsub|1><around*|(|n|)>=<big|sum><rsub|k=0><rsup|i-1>e<rsup|-\<beta\><rsub|1><around*|(|t<rsub|i>-t<rsub|k>|)>>>
  is defined by Equation (<reference|A>), and possibly
  <math|A<rsub|1><around*|(|n|)>=b<rsub|n>> and
  ...
  \ so that the expected time of the next point can be obtained by
  integrating the inverse compensator <math|\<Lambda\><rsub|><rsup|-1>> over
  <math|\<varepsilon\>> weighted by the unit negative exponential
  distribution

  <\equation>
    \<Epsilon\><around*|[|\<Lambda\><rsub|><rsup|-1><around*|(|\<varepsilon\>;\<alpha\><rsub|>,\<beta\><rsub|><rsub|>|)><around*|\||\<cal-F\><rsub|t>|\<nobracket\>>|]>=<big|int><rsub|0><rsup|\<infty\>>\<Lambda\><rsub|><rsup|-1><around*|(|\<varepsilon\>;\<alpha\><rsub|>,\<beta\><rsub|><rsub|>|)>e<rsup|-\<varepsilon\>>\<mathd\>\<varepsilon\>
  </equation>

  or alternatively, the point estimate, since the expected value of
  <math|\<varepsilon\>=1>,

  <\equation>
    t<rsub|i+1>=\<Lambda\><rsup|-1><around*|(|1;\<alpha\>,\<beta\>|)><with|font-base-size|14|||||>
  </equation>

  \;

  The recursive equations with initial conditions <math|b<rsub|0>=1> and
  <math|a<rsub|0>=e<rsup|\<beta\><rsub|>t<rsub|0>>> are
...
<\references>
  <\collection>
    ...
    <associate|lambertW6|<tuple|39|7>>
    <associate|mc|<tuple|69|11>>
    <associate|mp|<tuple|64|10>>
    <associate|multivarPred|<tuple|1.4.1|10>>
    <associate|prediction|<tuple|42|8>>
    <associate|uc|<tuple|46|8>>
    <associate|univarPred|<tuple|1.3|10>>
    <associate|up|<tuple|62|10>>
  </collection>
</references>
